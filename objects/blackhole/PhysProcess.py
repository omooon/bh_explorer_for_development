...
class RadiationProcess(PhysProcess):
...
class HawkingProcess(RadiationProcess):
    def __init__(self, name, radiation_functions={}):
        '''Provide a lambda function of Hawking radiation d^2N/dE/dt for each particle taking the energy as the argument.'''
        super().__init__(name=name, radiation_functions=radiation_functions)
